...
//public for simplicity sake
    ...
    ZigzagBezierPoint() : position(Point()), rightHandle(Point()), leftHandle(Point()), frequency(50), amplitude(5){}
    ZigzagBezierPoint(Point p, Point right, Point left) : position(p), rightHandle(right), leftHandle(left), frequency(50), amplitude(5){}
